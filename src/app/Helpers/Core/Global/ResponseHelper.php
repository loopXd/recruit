...
if (!function_exists('nothing_to_update_response')) {
    function nothing_to_update_response($message, $data = []) {
        return resolve(ResponseHelper::class)->nothingChangeResponse($message, $data);
    }
}
