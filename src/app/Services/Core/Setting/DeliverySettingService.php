...
class DeliverySettingService extends BaseService
{
    ...
    public function getCachedFormattedStorageSettings($context)
    {
        return cache()->remember('app-storage-settings-global', 84000, function () use ($context){
            return $this->getFormattedDeliverySettings(
                            $context
                        );
        });
    }
